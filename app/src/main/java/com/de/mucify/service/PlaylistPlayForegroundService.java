...
public class PlaylistPlayForegroundService extends IntentService {
    static PlaylistPlayForegroundService sInstance = null;
    ...
    public PlaylistPlayForegroundService() {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        if(PlaylistAudioController.get().isPlaylistNull() || mAlreadyReset)
            return;
    ...
    public static PlaylistPlayForegroundService get() { return sInstance; }
...
//        RemoteViews notificationLayoutExpanded = new RemoteViews(getPackageName(), R.layout.song_loop_playing_foreground_notification_large);
        ...
        Intent clickIntent = new Intent(this, MultiAudioPlayActivity.class);
        clickIntent.putExtra("PreservePlaylist", true);
